...
This project is a compilation of two tables (one for crop productions, one for animal productions) summarizing **the main key figures about world farming**, based on data from the FAO. The R scripts and data used to create these tables are available in this repository.
