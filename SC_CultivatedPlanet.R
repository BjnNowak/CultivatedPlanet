...
data<-read_csv('https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/FAO_CropsProductivity_subset.csv')
...
# Subset with only necessary data for this table:
balance<-read_csv('https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/FAO_FoodBalance_subset.csv')
...
whole_table <- area%>%
  ...
  mutate(Pic2=case_when(
    Item=='Wheat'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Wheat2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>",
    Item=='Maize'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Corn2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>",
    Item=='Rice'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Rice2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>",
    Item=='Soybeans'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Soybeans2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>",
    Item=='Barley'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Barley2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>",
    Item=='Sorghum'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Sorghum2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>",
    Item=='Cotton'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Cotton2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>",
    Item=='Rapeseed'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Rapeseed2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>",
    Item=='Beans'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Beans2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>",
    Item=='Millet'~"<img src='https://raw.githubusercontent.com/BjnNowak/CultivatedPlanet/main/Millet2.png' style='border-radius: 0% 100% 15% 45% / 0% 45% 15% 100%;height:80px;'>"
  ))
